...
const NewsFeed = () => (
  <section className="bg-[#f6fbfc] py-12  md:mt-20">
    <div className="max-w-7xl mx-auto px-4">
      <span className="text-[#fd5a3e] text-sm font-medium block mb-2">News & Blogs</span>
        ...
        {newsFeeds.map((feed, idx) => (
          <div key={idx} className="bg-white shadow rounded-lg overflow-hidden flex flex-col transition hover:shadow-lg">
            ...
            <div className="px-6 py-5 flex flex-col flex-1">
              <div className="flex items-center gap-2 mb-2 text-[#fd5a3e] text-xs font-medium">
                <span>by: Admin</span>
                <span className="mx-2">•</span>
                <span>{feed.category}</span>
              </div>
              <div className="font-bold text-lg mb-4 text-[#212121]">{feed.title}</div>
              <div className="flex items-center justify-between text-sm text-[#fd5a3e] mt-auto">
