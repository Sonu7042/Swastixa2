...
const Neighbourhood = () => (
  <section className="py-5 bg-[#f6fbfc]">
    <div className="max-w-7xl mx-auto px-4">
      <span className="text-[#fd5a3e] text-sm block mb-1 font-medium">Explore Neighbour</span>
      ...
      <div className="flex flex-col lg:flex-row gap-10">
        ...
        <div className="w-full lg:w-2/3 flex flex-col items-center">
          <div className="w-full h-64 sm:h-72 lg:h-[340px] bg-gray-200 relative overflow-hidden rounded-lg mb-6 flex items-center justify-center">
            <img src={img1} alt="Main building" className="object-cover h-full w-full" />
            {/* Thumbnails */}
          ...
          {/* Features Grid (on mobile stacked below images) */}
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 w-full">
            {features.map((feat, idx) => (
              <div key={feat.label} className="flex items-center bg-white rounded px-4 py-4 shadow-sm font-semibold text-lg text-[#212121]">
                <div className="w-9 h-9 flex items-center justify-center bg-[#fd5a3e] text-white rounded mr-3 text-xl">
                  {feat.icon}
                </div>
                {feat.label}
                <span className="ml-auto text-[#fd5a3e] text-xl font-bold">+</span>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="lg:w-1/3 w-full">
          <div className="bg-white rounded-lg shadow p-0 pb-6 flex flex-col overflow-hidden transition hover:shadow-lg">
            ...
            <div className="px-6 mt-5">
              ...
              <div className="text-[#fd5a3e] text-sm mb-2">
              ...
              <a href="#" className="text-[#fd5a3e] font-medium text-sm hover:underline transition">
