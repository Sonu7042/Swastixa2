...
function About() {
  return (
    <section className="w-full bg-gradient-to-b from-[#f5f9fd] to-white py-16 mt-5 " >
      <p className="text-[#284181] font-semibold mb-0 text-3xl text-center">About Us</p>
  ...
  <div className="flex-1 flex flex-col justify-center p-6 md:p-12 lg:p-24">
    <span className="text-[#284181] font-semibold mb-3">Building Facilities</span>
  ...
  <div className="flex-1 relative min-h-[250px] h-64 md:h-auto">
    ...
    />
    <div className="absolute top-1/2 -left-6 transform -translate-y-1/2 bg-[#284181] rounded-full w-14 h-14 md:w-16 md:h-16 flex items-center justify-center shadow-lg">
